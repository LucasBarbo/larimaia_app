...
public class ApiWeb {
    ...
    public static final String BASE_URL = "http://192.168.0.104:8080/larimaiawebapi/ws";
    ...
    public interface Rotas{
        ...
        public void editarCerimonial(@Path("id") long id, Callback<Cerimonial> callback);
